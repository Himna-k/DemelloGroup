...
def register_business(request):
    if request.method == 'POST':
        # Collect user information from the form (no password needed)
        ...
        # Create a new user without a password (you can omit this field)
        try:
            ...
            if created:
                ...
                user.save()
                messages.success(request, f"User created successfully with username: {username}")
            else:
        ...
        # Collect and validate form data for business registration
        business_data = {
            'user': user,
